...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Kiril', amount = 1)   # Define the sender, the receiver(miner), and the amount a receiver gets for mining the block
